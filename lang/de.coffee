...
module.exports =
  ...
  nav:
    ...
    play: ['Spiele', 'Multiplayer!']
    games: ['Server', 'spiel&#x2019; mit']
    league: ['Liga', 'wer ist der große Zampano?']
  ...
  index:
    ...
    download:
      version: 'Version:'
      oc: 'in Entwicklung'
      lc_link: 'https://forum.clonkspot.org/t/legacyclonk-334-ist-da-community-update-fuer-clonk-rage/1245'
